...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Navigation Drawer */}
      <aside className={`
        fixed inset-y-0 left-0 z-40 w-64 bg-[#0a0a0f] border-r border-purple-500/20 flex flex-col h-screen overflow-y-auto text-gray-300 flex-shrink-0 transform transition-transform duration-300 ease-in-out
