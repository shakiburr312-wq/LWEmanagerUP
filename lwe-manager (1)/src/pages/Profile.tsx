...
export const Profile: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#050507]">
      ...
      <main className="flex-1 p-4 md:p-8 pt-20 md:pt-8 overflow-y-auto font-sans">
                ...
                {playerProfile && (
                  <div className="bg-[#050507]/40 border border-white/5 rounded-2xl p-4 grid grid-cols-2 gap-4 text-xs font-mono">
                    <div>
                      ...
                      <strong className="text-emerald-400 uppercase mt-0.5 block">{playerProfile.status}</strong>
                    </div>
                    <div>
                      <span className="text-gray-500 block text-[9px] uppercase">Current Lineup</span>
                      <strong className="text-purple-400 uppercase mt-0.5 block">{playerProfile.lineup || '1st Lineup'}</strong>
                    </div>
                  </div>
                )}
              </div>
