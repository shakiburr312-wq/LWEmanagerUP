...
import { InvestmentCampaign, SiteSettings } from '../types';
...
export const MatchCampaigns: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#050507] text-gray-100">
      <Sidebar />

      <main className="flex-1 p-4 md:p-8 overflow-y-auto max-w-7xl mx-auto space-y-8 w-full">
